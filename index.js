...
const dispEntries = () => {
    ...
    const tableEntries = entries.map((entry) => {
        const name = `<td class="a5">${entry.name}</td>`;
        const email = `<td class="a5">${entry.email}</td>`;
        const password = `<td class="a5">${entry.password}</td>`;
        const dateOfBirth = `<td class="a5">${entry.dob}</td>`; 
        const atnc = `<td class="a5">${entry.atnc}</td>`;
